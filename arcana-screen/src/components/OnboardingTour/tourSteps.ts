...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Once widgets are on the grid, drag them to reorder your screen. The responsive grid adapts the layout to the available space.',
    target: 'main.flex-1.overflow-auto',
    position: 'top',
    showNext: true,
    showPrev: true,
  ...
  },
  {
    ...
    target: '.surface.rounded.shadow-md',
    position: 'bottom',
    showNext: true,
    showPrev: true,
    showSkip: true,
