...
B2. **Instant NPC minting** — next: one tap mints a named Entity (name + trait + want + voice) from a tiny local table, drops into the scene and becomes linkable. Bigger (data tables) — budget a sweep first (JS 554.8/560, CSS 108.4/110).
